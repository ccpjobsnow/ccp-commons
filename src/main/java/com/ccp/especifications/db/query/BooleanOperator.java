...
abstract class BooleanOperator extends Component{
	...
	public <T extends BooleanOperator> T term(CcpField field, Object value) {
		T addCondition = this.addCondition(field.name(), value, "term");
		return addCondition;
	}

	public <T extends BooleanOperator> T prefix(CcpField field, Object value) {
		T addCondition = this.addCondition(field.name(), value, "prefix");
		return addCondition;
	}

	public <T extends BooleanOperator> T match(CcpField field, Object value) {
		T addCondition = this.addCondition(field.name(), value, "match");
		return addCondition;
	}

	public <T extends BooleanOperator> T matchPhrase(CcpField field, Object value) {
		T addCondition = this.addCondition(field.name(), value, "match_phrase");
		return addCondition;
	}

	public <T extends BooleanOperator> T match(CcpField field, Object value, double boost, String operator) {
		T addCondition = this.addCondition(field.name(), value, "match", boost, operator);
		return addCondition;
	}

	public <T extends BooleanOperator> T matchPhrase(CcpField field, Object value, double boost) {

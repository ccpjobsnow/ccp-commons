...
public final class Should  extends BooleanOperator {
	...
	public Should prefix(CcpField field, Object value) {
	...
	public Should matchPhrase2(CcpField field, Object value) {
		return super.matchPhrase(field, value);
	}

	@Override
	@SuppressWarnings("unchecked")
	public Should match(CcpField field, Object value) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public Should term(CcpField field, Object value) {

...
public final class SimplifiedQuery  extends BooleanOperator {
	...
	public SimplifiedQuery prefix(CcpField field, Object value) {
	...
	SimplifiedQuery addChild(Component child) {
		...
		@Override
		@SuppressWarnings("unchecked")
		public SimplifiedQuery matchPhrase(CcpField field, Object value) {
			return super.matchPhrase(field, value);
		}

		@Override
		@SuppressWarnings("unchecked")
		public SimplifiedQuery term(CcpField field, Object value) {
			return super.term(field, value);
		}
		
		@Override
		@SuppressWarnings("unchecked")
		public SimplifiedQuery match(CcpField field, Object value) {
